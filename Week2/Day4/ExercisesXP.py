...
def compare_numbers (user_number):
    ...
    print (random_number)
    if user_number in range (1,101) and user_number == random_number:
        print ('Success!')
...
def make_great(magician_names):
    magician_names_new = []
    for name in magician_names:
        magician_names_new.append(name + ' the Great')
    return magician_names_new
        
magician_names_new = make_great(magician_names)
show_magicians(magician_names_new)
